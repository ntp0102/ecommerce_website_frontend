...
function ProductScreen({ match, history }) {
    ...
    const addToCartHandler = () => {
        const itemInCart = cartItems.filter((item) => String(item._id) === match.params.id)
        if (itemInCart.length !== 0) {
            if (product.countInStock < Number(qty) + itemInCart[0].qty) {
                Swal.fire({
                    position: 'top-end',
                    icon: 'error',
                    title: 'Adding this item to cart failed because there are only ' +
                    ...
                    <Row>
                        ...
                        <Col md={6}>
                            <ListGroup variant="flush">
                                ...
                                <ListGroup.Item>Price: {Math.trunc(product.price)} VND</ListGroup.Item>
                                ...
                                <ListGroup variant="flush">
                                    <ListGroup.Item>
                                        <Row>
                                            <Col>Price:</Col>
                                            <Col>
                                                <strong>{Math.trunc(product.price)} VND</strong>
                                            </Col>
                                        </Row>
                                    </ListGroup.Item>
